...
export const dictionaries: Record<Lang, Dictionary> = {
  ar: {
    ...
    micHintTeacher:
      "تكلم عربي أو إنجليزي — الترجمة تظهر للطرفين في العمودين.",
    micHintBoth:
      "تحدث أو اكتب في الحقل — صحّح النص إن لزم ثم يُترجم. الصوت يُرفق مع الإرسال.",
    ...
    tapToRecord: "اضغط للتسجيل — اضغط مجدداً للإيقاف، صحّح النص إن لزم ثم إرسال",
    ...
    speechUnsupported:
      "هذا المتصفح لا يدعم التحدث. افتح الموقع في Chrome على أندرويد، أو اكتب في الحقل.",
    noSpeechHeard: "لم نسمع كلاماً — تحدث مجدداً أو اكتب في الحقل.",
    uploadingAudio: "يرفع الصوت…",
    typeWhatYouSaid: "الصوت جاهز — اكتب أو صحّح النص هنا ثم إرسال (يُترجم فوراً)",
  ...
  en: {
    ...
    micHintTeacher:
      "Speak Arabic or English — translations show for both people in both columns.",
    micHintBoth:
      "Speak or type in the box — correct the text if needed, then it translates. Audio attaches on send.",
    ...
    tapToRecord: "Tap to record — tap again to stop, correct text if needed, then Send",
    ...
    speechUnsupported:
      "This browser cannot speak-to-text. Use Chrome on Android, or type in the box.",
    noSpeechHeard: "No speech heard — speak again or type in the box.",
    uploadingAudio: "Uploading audio…",
    typeWhatYouSaid: "Audio ready — type or correct the text here, then Send (translates instantly)",
